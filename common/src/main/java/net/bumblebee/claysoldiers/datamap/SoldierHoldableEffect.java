...
public final class SoldierHoldableEffect {
    ...
    public ItemStackWithEffect applyThrowableTransform(@NonNull ItemStackWithEffect stack) {
    ...
    public static class Builder {
        ...
        public Builder setThrowableTransform(ThrowableTransform throwableTransform) {
            this.throwableTransform = throwableTransform;
            return this;
        }
