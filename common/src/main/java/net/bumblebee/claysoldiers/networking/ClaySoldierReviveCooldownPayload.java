...
public class ClaySoldierReviveCooldownPayload implements IClientPayload {
    public static final Type<ClaySoldierReviveCooldownPayload> ID = new Type<>(Identifier.fromNamespaceAndPath(ClaySoldiersCommon.MOD_ID, "clay_soldier_revive_map"));
