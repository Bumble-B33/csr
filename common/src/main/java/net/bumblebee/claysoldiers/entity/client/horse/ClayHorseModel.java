...
public class ClayHorseModel extends AbstractEquineModel<ClayHorseRenderState> {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(Identifier.fromNamespaceAndPath(ClaySoldiersCommon.MOD_ID, "clay_horse"), "main");
    public static final ModelLayerLocation ARMOR_LAYER_LOCATION =
            new ModelLayerLocation(Identifier.fromNamespaceAndPath(ClaySoldiersCommon.MOD_ID, "clay_horse"), "armor");
