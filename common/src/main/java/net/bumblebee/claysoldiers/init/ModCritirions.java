...
public class ModCritirions {
    ...
    public static final Supplier<RecipeCraftedTrigger> CHIP_ASSEMBLER_CRAFTED_TRIGGER = ClaySoldiersCommon.PLATFORM.registerCriterionTrigger("chip_assembler_recipe_crafted",
            RecipeCraftedTrigger::new
    );
