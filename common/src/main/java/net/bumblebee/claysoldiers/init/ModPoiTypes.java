...
public class ModPoiTypes {
    ...
    public static final ResourceKey<PoiType> CHARGING_PAD_KEY = ResourceKey.create(Registries.POINT_OF_INTEREST_TYPE, Identifier.fromNamespaceAndPath(ClaySoldiersCommon.MOD_ID, "charing_pad"));
    ...
    public static final Supplier<PoiType> CHARGING_PAD = ClaySoldiersCommon.PLATFORM.registerPoiType(CHARGING_PAD_KEY,
            () -> new PoiType(ImmutableSet.<BlockState>builder()
                    .addAll(ModBlocks.SOLDIER_CHARGING_PAD.get().getStateDefinition().getPossibleStates())
                    .build(), 0, 1)
    );
