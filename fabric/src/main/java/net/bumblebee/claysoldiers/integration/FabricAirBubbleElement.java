...
public class FabricAirBubbleElement extends Element {
    ...
    public FabricAirBubbleElement(int breath, boolean bursting) {
    ...
    public void render(GuiGraphics guiGraphics, float x, float y, float maxX, float maxY) {
        ...
        for (int i = iconCount; i > 0; --i) {
            if (bursting && i == iconCount) {
                helper.blitSprite(guiGraphics, RenderType::guiTextured, AIR_BUBBLE_BURSTING, (int) (x + xOffset), (int) (y + yOffset), 9, 9);
            } else if (i <= Mth.floor(armor)) {
                helper.blitSprite(guiGraphics, RenderType::guiTextured, AIR_BUBBLE, (int) (x + xOffset), (int) (y + yOffset), 9, 9);
            }
